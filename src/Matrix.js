...
var sketch = function(p5) {
  p5.setup = function() {
    p5.createCanvas(window.screen.width, p5.windowHeight)
    createStreams()
    p5.background(0)
  }
  ...
  function createStreams() {
    ...
    for (var i = 0; i < p5.round(window.screen.width/symbolSize); i++) {
...
export default class Matrix extends React.Component {
  ...
  render() {
    return (
      <div>
        <div className="wrapper" id="wrapper" ref="wrapper"></div>
      </div>
